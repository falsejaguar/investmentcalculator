...
class mWindow(qtw.QMainWindow, Ui_MainWindow):
    def __init__(self):
       ...
       # title_font = QFont("RozhaOne-Regular", 48)
        ...
        self.titleLabel.setStyleSheet("font-family: 'Rozha One'; font-weight: 400; font-size: 48px; color: #f0e68c;background-color: qradialgradient(spread:pad, cx:0.5, cy:0.5, radius:0.5, fx:0.5, fy:0.5, stop:0 rgba(255, 235, 235, 206), stop:0.35 rgba(255, 188, 188, 80), stop:0.4 rgba(255, 162, 162, 80), stop:0.425 rgba(255, 132, 132, 156), stop:0.44 rgba(252, 128, 128, 80), stop:1 rgba(255, 255, 255, 0));")
