...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        brush3 = QBrush(QColor(200, 243, 100, 255))
        brush3.setStyle(Qt.SolidPattern)
        palette.setBrush(QPalette.Active, QPalette.Highlight, brush3)
        brush4 = QBrush(QColor(37, 40, 182, 255))
        ...
        brush6 = QBrush(QColor(40, 44, 48, 255))
...
"    background-color: #A0A0A0; /* Grey background when dis"
                        "abled */\n"
"    border: 3px solid #A0A0A0; /* Grey border when disabled */\n"
